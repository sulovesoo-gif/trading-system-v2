...
UPDATE daily_strategy_operation o SET effective_to=CURRENT_TIMESTAMP,change_reason='SELECTION_LIVE_INITIAL_APPROVAL',
...
WITH inserted AS (
 ...
 SELECT strategy_id,'LIVE',recommended_amount,1,CURRENT_TIMESTAMP,'SELECTION_LIVE_INITIAL_APPROVAL','USER_APPROVED_20260825','initial LIVE operation; actual send remains locked'
