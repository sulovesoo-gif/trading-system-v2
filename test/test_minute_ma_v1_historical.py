...
class V1HistoricalTest(unittest.TestCase):
    ...
    def test_research_schema_is_provenance_isolated(self):
        ...
        self.assertIn('class="strategy-card"',page)
        self.assertIn('class="strategy-line primary-line"',page)
        self.assertIn('class="strategy-line secondary-line"',page)
        self.assertIn("#v1Section table{min-width:0",page)
