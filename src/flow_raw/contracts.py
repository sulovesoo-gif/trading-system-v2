...
# Operating evidence from 2026-09-14: one more trailing gateway value.
# Keep all existing indices; the additional value has no assigned semantics.
EXECUTION_GATEWAY_47_FIELDS = EXECUTION_FIELDS + ("KIS_UNDOCUMENTED_FIELD_47",)
ORDERBOOK_GATEWAY_63_FIELDS = ORDERBOOK_GATEWAY_62_FIELDS + ("KIS_UNDOCUMENTED_FIELD_63",)

FIELDS = {TR_EXECUTION: EXECUTION_FIELDS, TR_PROGRAM: PROGRAM_FIELDS, TR_ORDERBOOK: ORDERBOOK_FIELDS}
FIELD_VARIANTS = {
    TR_EXECUTION: {
        len(EXECUTION_FIELDS): EXECUTION_FIELDS,
        len(EXECUTION_GATEWAY_47_FIELDS): EXECUTION_GATEWAY_47_FIELDS,
    },
    ...
    TR_ORDERBOOK: {
        ...
        len(ORDERBOOK_GATEWAY_63_FIELDS): ORDERBOOK_GATEWAY_63_FIELDS,
    },
}
