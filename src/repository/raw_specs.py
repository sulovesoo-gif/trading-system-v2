...
RAW_SPECS: dict[RawTable, RawTableSpec] = {
    ...
    RawTable.STOCK_MINUTE: RawTableSpec(RawTable.STOCK_MINUTE, "14_raw_stock_minute.sql", VENUE_BAR + ("stock_code", "open_price", "high_price", "low_price", "close_price", "previous_close_price", "volume", "accumulated_amount", "raw_payload"), ("bar_time", "data_source", "market_code", "trading_venue", "collect_cycle", "stock_code")),
