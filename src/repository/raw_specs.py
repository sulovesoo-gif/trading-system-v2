...
RAW_SPECS: dict[RawTable, RawTableSpec] = {
    ...
    RawTable.STOCK_QUOTE: RawTableSpec(RawTable.STOCK_QUOTE, "12_raw_stock_quote.sql", COMMON_SNAPSHOT + ("stock_code", "current_price", "previous_day_difference", "previous_day_difference_sign", "change_rate", "open_price", "high_price", "low_price", "base_price", "upper_limit_price", "lower_limit_price", "accumulated_volume", "accumulated_amount", "weighted_average_price", "foreign_net_buy_volume", "program_net_buy_volume", "vi_classification_code", "trading_halt_yn", "raw_payload"), ("snapshot_time", "data_source", "market_code", "collect_cycle", "stock_code")),
    RawTable.STOCK_EXECUTION: RawTableSpec(RawTable.STOCK_EXECUTION, "13_raw_stock_execution.sql", COMMON_SNAPSHOT + ("stock_code", "current_price", "previous_day_difference", "previous_day_difference_sign", "change_rate", "execution_volume", "execution_strength", "raw_payload"), ("snapshot_time", "data_source", "market_code", "collect_cycle", "stock_code")),
    RawTable.STOCK_MINUTE: RawTableSpec(RawTable.STOCK_MINUTE, "14_raw_stock_minute.sql", COMMON_BAR + ("stock_code", "open_price", "high_price", "low_price", "close_price", "volume", "accumulated_amount", "raw_payload"), ("bar_time", "data_source", "market_code", "collect_cycle", "stock_code")),
    RawTable.STOCK_DAILY: RawTableSpec(RawTable.STOCK_DAILY, "15_raw_stock_daily.sql", ("trade_date", "collected_at", "data_source", "market_code", "collect_cycle", "stock_code", "open_price", "high_price", "low_price", "close_price", "volume", "amount", "previous_day_difference", "previous_day_difference_sign", "adjusted_yn", "split_rate", "raw_payload"), ("trade_date", "data_source", "market_code", "collect_cycle", "stock_code")),
    RawTable.FUTURES_QUOTE: RawTableSpec(RawTable.FUTURES_QUOTE, "16_raw_futures_quote.sql", COMMON_SNAPSHOT + ("futures_code", "futures_name", "current_price", "previous_day_difference", "previous_day_difference_sign", "previous_close_price", "change_rate", "open_price", "high_price", "low_price", "upper_limit_price", "lower_limit_price", "base_price", "accumulated_volume", "accumulated_amount", "open_interest", "open_interest_change", "basis", "theoretical_price", "market_basis", "expiration_date", "days_to_expiration", "raw_payload"), ("snapshot_time", "data_source", "market_code", "collect_cycle", "futures_code")),
    RawTable.FUTURES_MINUTE: RawTableSpec(RawTable.FUTURES_MINUTE, "17_raw_futures_minute.sql", COMMON_BAR + ("futures_code", "open_price", "high_price", "low_price", "close_price", "volume", "accumulated_amount", "raw_payload"), ("bar_time", "data_source", "market_code", "collect_cycle", "futures_code")),
}
