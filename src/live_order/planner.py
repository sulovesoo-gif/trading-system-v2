...
class OrderPlanner:
 ...
 def plan(self,*,intent:LiveIntent,reference_price:float|None,now:datetime,live_enabled:bool,global_trade_yn:str,has_real_position:bool=False):
  ...
  if safe.reason=='GLOBAL_TRADE_DISABLED':self.store.audit('GLOBAL_TRADE_DISABLED',{'intent_id':intent.intent_id,'strategy_instance_id':intent.strategy_instance_id})
